...
# ------------------------------------------------------------ 7. SCORING
print("\n[7] scoring")
check("hard route perfect = 800", ae.estimate_section_score(54, 54, "hard") == 800)
check("easy route perfect is capped", ae.estimate_section_score(54, 54, "easy") <= 640,
      str(ae.estimate_section_score(54, 54, "easy")))
check("easy route ceiling < hard route perfect",
      ae.estimate_section_score(54, 54, "easy") < ae.estimate_section_score(54, 54, "hard"))
check("zero correct floors at 200", ae.estimate_section_score(0, 54, "easy") == 200)
check("scores are multiples of 10", all(ae.estimate_section_score(k, 54, "hard") % 10 == 0 for k in range(0, 55)))
mono = [ae.estimate_section_score(k, 54, "hard") for k in range(0, 55)]
...
check("zero-question section scores 0", ae.estimate_section_score(0, 0, "hard") == 0)
