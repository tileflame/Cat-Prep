...
class PlanScreen(ctk.CTkFrame):
    ...
    def _week_card(self):
        ...
        if not week:
            ...
            ui.title(card, "Outside the seven-week plan", size=16).pack(
                anchor="w", padx=20, pady=(16, 4))
            ui.body(card, "The Command Center covers Aug 16 – Oct 3, 2026. Use the arrows "
                          "above to look at a day inside that window.",
