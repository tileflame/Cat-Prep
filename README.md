This is one of my best projects and the AI use is open I desgined the first structure then led AI to upgrade and actually ended up using it. I wrote some lines of code and debugeed but this version is AI. And I made this for a reason and I hope this fixes it. This is completely open source and free. Since the problem I kept seeing around the SAT study world was every app with a question bank or progress tracker was paid. And that annoyed me a lot. And the questionbank had no way to even safe progress or look at how far you've made it or safe you week areas. This aims to fix it and tries to make better use of code and sat prep to help students who can't afford it. I sued this for like 2 weeks and my score went up from a 1340 to a 1400, then I will keep using it since I have 2 more tries on the test and I'm aiming for a 1500. On the bottom of this I will explain exactly how it works and how to run it. It has everything but I just wanted to use this part to explain why I made it and my own personal thoughts.
